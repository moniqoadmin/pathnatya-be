...
export class TeamsController {
  ...
  @ApiOperation({
    summary:
      'Update one team by id (password reset, login disable, password). Optional admin query flag. Admins may only set setPassword (false → true) and isLoginDisabled, and only for Users in their sanghat. SuperAdmin and Developer may also set password.',
  })
  update(
    @Req() req: Request,
    @Param('accountId', ParseUUIDPipe) accountId: string,
